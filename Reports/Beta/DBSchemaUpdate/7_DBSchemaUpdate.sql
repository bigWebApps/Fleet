...
-- Generated Monday, April 17, 2006, at 06:20 AM
--
...
--
-- Script To Update dbo.sp_OrgsDetail Procedure In largo.BFS_Beta
-- Generated Monday, April 17, 2006, at 06:20 AM
--
-- Please backup largo.BFS_Beta before executing this script
--
...
PRINT 'Updating dbo.sp_OrgsDetail Procedure'
GO
...
SET ANSI_NULLS OFF
GO
exec('ALTER   procedure dbo.sp_OrgsDetail
(
	@Action char(1),
	@Id int output,
	...
	@vchNotes varchar(4000)=null output,
...
IF @@TRANCOUNT = 1
BEGIN
   PRINT 'dbo.sp_OrgsDetail Procedure Updated Successfully'
   COMMIT TRANSACTION
END ELSE
BEGIN
   PRINT 'Failed To Update dbo.sp_OrgsDetail Procedure'
END
GO

--
-- Script To Update dbo.sp_SelectOrgsListFromUser Procedure In largo.BFS_Beta
-- Generated Monday, April 17, 2006, at 06:20 AM
--
-- Please backup largo.BFS_Beta before executing this script
--
...
PRINT 'Updating dbo.sp_SelectOrgsListFromUser Procedure'
GO
...
IF @@TRANCOUNT = 1
exec('ALTER   PROCEDURE dbo.sp_SelectOrgsListFromUser
(
		@UserId int
)
AS
...
IF @@TRANCOUNT = 1
BEGIN
   PRINT 'dbo.sp_SelectOrgsListFromUser Procedure Updated Successfully'
   COMMIT TRANSACTION
END ELSE
BEGIN
   PRINT 'Failed To Update dbo.sp_SelectOrgsListFromUser Procedure'
END
GO
