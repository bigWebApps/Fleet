...
as
	...
	select 	RI.[Id],
		...
		case when isnull(RI.ServiceResultId, 0) > 0 and @btEnableLink = 1 then 'javascript:return confirm("This repair issue has been serviced. Select OK to continue and remove the service.")' else '' end as Confirmation
