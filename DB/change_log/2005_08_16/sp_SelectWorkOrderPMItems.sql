...
as
	...
	select 	PMI.[Id],
		...
		else case when isnull(PMI.ServiceCheckId, 0) = 3 and isnull(PMI.ServiceResultId, 0) = 0 
		...
		case when isnull(PMI.ServiceResultId, 0) > 0 and @btEnableLink = 1 
			then 'javascript:return confirm("This PM item has been serviced. Select OK to continue and remove the service.")' 
