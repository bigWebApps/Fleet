...
namespace BWA.BFP.Data
{
	...
	public class clsConnectionProvider : IDisposable
	{
		...
		private void InitClass()
		{
			...
			//m_scoDBConnection.ConnectionString = m_asrConfigReader.GetValue("BFPCntStr", typeof(string)).ToString();

			// Set connection string of the sqlconnection object
			m_scoDBConnection.ConnectionString = ConfigurationManager.ConnectionStrings["FleetSystem.ConnectionString"].ConnectionString;
