...
<form id="Form1" method="post" runat="server">
	<table>
		<TR>
			<TD colSpan="3">
				<font color="Red">Attention!</font> The Permissions is the common data for all 
				organizations and if you changes something in this screen then the changes will 
