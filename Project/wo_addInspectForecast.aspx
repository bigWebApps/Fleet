...
<form id="Form1" method="post" runat="server">
	<table>
		...
		<TR vAlign="top">
			...
			<TD class="RowElem" vAlign="middle"><cc1:activedatetime id="adtScheduled" runat="server" AllowNull="False" AlertEnabled="True" MinYear="1970"
					MaxYear="2020" Format="MONTH;/;DAY;/;YEAR;&nbsp;:&nbsp;;HOUR;/;MINUTE;/;MERIDIEM"></cc1:activedatetime><A id="html_ScheduledDate" style="CURSOR: pointer" onclick="javascript:OpenPopUpScheduleDate('adtScheduled', false)"
