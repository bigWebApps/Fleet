	...
	<table>
		...
		<TR vAlign="top">
			...
			<td class="RowElem"><cc1:activedatetime id="adtStartDate" runat="server" AlertEnabled="True" AllowNull="False" Format="MONTH;/;DAY;/;YEAR"
					MaxYear="2020" MinYear="1970"></cc1:activedatetime>&nbsp; <A id="A1" style="CURSOR: pointer" onclick="javascript:OpenCalendar('adtStartDate', false, event.screenX, event.screenY)"
		...
		<TR vAlign="top">
			...
			<td class="RowElem"><cc1:activedatetime id="adtEndDate" runat="server" AlertEnabled="True" AllowNull="False" Format="MONTH;/;DAY;/;YEAR"
					MaxYear="2020" MinYear="1970"></cc1:activedatetime>&nbsp; <A id="A2" style="CURSOR: pointer" onclick="javascript:OpenCalendar('adtEndDate', false, event.screenX, event.screenY)"
