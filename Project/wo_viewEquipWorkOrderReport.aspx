	...
	<table>
		<TBODY>
			...
			<TR vAlign="top">
				...
				<td class="RowElem"><cc1:activedatetime id="adtStartDate" runat="server" MinYear="1970" MaxYear="2020" Format="MONTH;/;DAY;/;YEAR"
			...
			<TR vAlign="top">
				...
				<td class="RowElem"><cc1:activedatetime id="adtEndDate" runat="server" MinYear="1970" MaxYear="2020" Format="MONTH;/;DAY;/;YEAR"
