...
<%@ Page language="c#" Codebehind="ok_viewCheckIn.aspx.cs" AutoEventWireup="false" Inherits="BWA.BFP.Web.operatorkiosk._ok_viewCheckIn" %>
<form id="Form1" method="post" runat="server">
	<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
		...
		<tr>
			<td colspan="2" style="FONT-SIZE: 18pt;"> <!-- FONT-FAMILY:'Courier New'; -->
		...
		<tr>
			<TD align="center" colspan="2">
				<br>
				<asp:HyperLink id="hlPrint" runat="server" Font-Size="18pt" Font-Bold="True">Print Check-In Receipt</asp:HyperLink>
				<br><br>
			</TD>
		</tr>
		<tr>
