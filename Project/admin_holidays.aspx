			...
			<td colSpan="3"><mits:datagrid_a id="dgHolidays" runat="server" DataKeyField="Id" Width="100%" AutoGenerateColumns="False"
					...
					<Columns>
						...
						<asp:TemplateColumn HeaderText="Start Date">
							...
							<EditItemTemplate>
								<cc1:activedatetime id="adtStartDate" runat="server" Date='<%# Convert.ToDateTime(DataBinder.Eval(Container, "DataItem.dtStartDate")) %>' MinYear="2000" MaxYear="2020" Format="MONTH;/;DAY;/;YEAR" AllowNull="False" AlertEnabled="True">
								</cc1:activedatetime>
							</EditItemTemplate>
						</asp:TemplateColumn>
						<asp:TemplateColumn HeaderText="End Date">
							...
							<EditItemTemplate>
								<cc1:activedatetime id="adtEndDate" runat="server" Date='<%# Convert.ToDateTime(DataBinder.Eval(Container, "DataItem.dtEndDate")) %>' MinYear="2000" MaxYear="2020" Format="MONTH;/;DAY;/;YEAR" AllowNull="False" AlertEnabled="True">
								</cc1:activedatetime>
							</EditItemTemplate>
						</asp:TemplateColumn>
...
&nbsp;
		...
		<TR valign="top">
			<TD>Start Date</TD>
			<TD>
				<cc1:activedatetime id="adtNewStartDate" runat="server" MinYear="2000" MaxYear="2020" Format="MONTH;/;DAY;/;YEAR"
		...
		<TR valign="top">
			<TD>End Date</TD>
			<TD>
				<cc1:activedatetime id="adtNewEndDate" runat="server" MinYear="2000" MaxYear="2020" Format="MONTH;/;DAY;/;YEAR"
					AllowNull="False" AlertEnabled="True"></cc1:activedatetime>
