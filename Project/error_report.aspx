...
<form id="Form1" method="post" runat="server">
	<table cellSpacing="0" cellPadding="0" width="100%" border="0">
		...
		<tr>
			<td nowrap>From:&nbsp;</td>
			<td nowrap><cc1:activedatetime id="adtReportFrom" runat="server" Format="MONTH;/;DAY;/;YEAR" MaxYear="2020" MinYear="1970"
					AlertEnabled="True" AllowNull="False" Enabled="True"></cc1:activedatetime></td>
			<td nowrap>&nbsp;&nbsp;&nbsp;&nbsp;To:&nbsp;</td>
			<TD nowrap><cc1:activedatetime id="adtReportTo" runat="server" Format="MONTH;/;DAY;/;YEAR" MaxYear="2020" MinYear="1970"
					AlertEnabled="True" AllowNull="False" Enabled="True"></cc1:activedatetime></TD>
			<td width="100%">&nbsp;
