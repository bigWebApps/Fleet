...
{
	public class _e_editCustom : BFPPage
	{
		...
		protected override void OnLoad(EventArgs e)
		{
			try
			{
				SourcePageName = "e_editCustom.aspx.cs";
				base.OnLoad(e);
			}
			catch(Exception ex)
			{
		...
		/// <summary>
		/// Update the custom fields for current equipment
		/// </summary>
		...
		private void btSave_FormSubmit(object sender, EventArgs e)
		{
			...
			try
			{
				...
				#region Get Data for custom fields update
				...
				{
					Session["lastpage"] = "e_editCustom.aspx?id=" + EquipId.ToString();
		...
		/// <summary>
		/// if there are lookup data to custom fields then to show them
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
