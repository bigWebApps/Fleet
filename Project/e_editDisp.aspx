...
<FORM id="Form1" runat="server">
	<TABLE>
		<TR>
			...
			<TD class="RowElem" height="18"><cc1:activedatetime id="adtOutOfService" runat="server" MinYear="1970" MaxYear="2020" Format="MONTH;/;DAY;/;YEAR"
		...
		<TR>
			...
			<TD class="RowElem" height="28"><cc1:activedatetime id="adtDisposed" runat="server" MinYear="1970" MaxYear="2020" Format="MONTH;/;DAY;/;YEAR"
					AllowNull="False" AlertEnabled="True"></cc1:activedatetime>
