...
<form id="Form1" method="post" runat="server">
	<TABLE>
		...
		<TR vAlign="top">
			...
			<td class="RowElem" nowrap><cc1:activedatetime id="adtScheduled" runat="server" AllowNull="False" AlertEnabled="True" MinYear="1970"
					MaxYear="2020" Format=";MONTH;/;DAY;/;YEAR;<br>;HOUR; ;MINUTE; ;MERIDIEM"></cc1:activedatetime>
		...
		<TR vAlign="top" id="trCheckInDate" runat="server">
			...
			<td class="RowElem"><cc1:activedatetime id="adtCheckIn" runat="server" AllowNull="False" AlertEnabled="True" MinYear="1970"
		...
		<TR vAlign="top" id="trOpenedDate" runat="server">
			...
			<td class="RowElem"><cc1:activedatetime id="adtOpened" runat="server" AllowNull="False" AlertEnabled="True" MinYear="1970"
					MaxYear="2020" Format=";MONTH;/;DAY;/;YEAR;"></cc1:activedatetime></td>
			<td class="RowHelp"></td>
		</TR>
		<TR vAlign="top" id="trClosedDate" runat="server">
			<TD class="RowCap">Closed Date</TD>
			<td class="RowElem"><cc1:activedatetime id="adtClosed" runat="server" AllowNull="False" AlertEnabled="True" MinYear="1970"
					MaxYear="2020" Format=";MONTH;/;DAY;/;YEAR;"></cc1:activedatetime></td>
			<td class="RowHelp"></td>
		</TR>
		<TR vAlign="top" id="trCheckOutDate" runat="server">
			<TD class="RowCap">Check-Out Date</TD>
			<td class="RowElem"><cc1:activedatetime id="adtCheckOut" runat="server" AllowNull="False" AlertEnabled="True" MinYear="1970"
					MaxYear="2020" Format=";MONTH;/;DAY;/;YEAR;"></cc1:activedatetime></td>
			<td class="RowHelp"></td>
		</TR>
		<TR vAlign="top">
