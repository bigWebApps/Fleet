		...
		<form id="Form1" method="post" runat="server">
			<table id="tblMain" runat="server">
				...
				<tr valign="middle">
					...
					<td nowrap><cc1:activedatetime id="adtLastTime" runat="server" AllowNull="False" AlertEnabled="True" MinYear="1970"
							MaxYear="2020" Format="MONTH;/;DAY;/;YEAR"></cc1:activedatetime>
