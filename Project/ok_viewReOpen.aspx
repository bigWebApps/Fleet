<%@ Page language="c#" Codebehind="ok_viewReOpen.aspx.cs" AutoEventWireup="false" Inherits="BWA.BFP.Web.operatorkiosk._ok_viewReOpen" %>
<%@ Register TagPrefix="uc1" TagName="NextBack" Src="controls/NextBack.ascx" %>
<form id="Form1" method="post" runat="server">
	<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
		<tr>
			<td align="center" colSpan="2"><br>
				<h1><asp:Label id="lblFirstName" runat="server"></asp:Label>,&nbsp;The work order 
					for&nbsp;
