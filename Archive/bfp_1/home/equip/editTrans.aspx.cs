...
{
	public class editTrans : BFPPage
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			PageTitle = "Equipment-Edit Transmission";
			...
			{	
				if(EquipId!=0) //Look up existing values
				{
					...
					int returnValue;
					SqlCommand cmd;
					DataSet dsobj=dbobj.dsRunProcedure("sp_EquipTransDetail",parameters,out returnValue,"Trans",out cmd);
					...
					if(returnValue!=-1) {
						...
						dsobj.Relations.Add(new DataRelation("Makes_Models", dsobj.Tables["Trans"].Columns["Id"],dsobj.Tables["Trans1"].Columns["MakeId"] ) );

						ddMake.DataSource = dsobj;
						ddMake.DataMember = "Trans";
		...
		private void btSave_FormSubmit(object sender, EventArgs e) {
			...
			dbobj.RunProcedure("sp_EquipTransDetail",parameters);
