namespace BWA.BFP.Web.Controls.User
{
	...
	public abstract class Header : System.Web.UI.UserControl
	{
		...
		{
			string webroot = Request.ApplicationPath;
			HtmlHeadAttr.Text="<link href='"+webroot+"/global.css' type=\"text/css\" rel=\"stylesheet\">";
			...
			//TopMenu
			if(topMenuSelected!="0"){temp1.Append("<tr><td colspan="+colSpan+" height=20px><table width=\"100%\"><tr><td>TOP BAR</td></tr></table></td></tr><tr>");}
			//Left Menu Bar
			...
			//Bread Crumbs
			if(brdCrumbs!=null){temp1.Append(brdCrumbs+"<br><br>");};
			//Page Title
