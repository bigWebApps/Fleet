...
<%@ Page language="c#" Codebehind="edit.aspx.cs" AutoEventWireup="false" Inherits="BWA.BFP.Web.home.equip._edit" errorPage="error.aspx"%>
...
<form id="Form1" method="post" runat="server">
	<TABLE id="tblEquipment">
		...
		<TR>
			<TD class="RowCap">Assigned To</TD>
			<TD class="RowElem"><asp:label id="lblAssignedTo" runat="server"></asp:label></TD>
			<TD class="RowHelp"></TD>
		</TR>
		<TR>
			<TD class="RowCap">Reassign</TD>
