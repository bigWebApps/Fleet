<%@ Page language="c#" Codebehind="editComponent.aspx.cs" AutoEventWireup="false" Inherits="BWA.BFP.Web.home.equip._editComponent" %>
...
<form id="Form1" method="post" runat="server">
	<TABLE id="tblComponent">
		...
		<TR>
			<TD></TD>
			<TD>
				<asp:Button id="btnRemove" runat="server" Text="Remove Component"></asp:Button></TD>
			<TD></TD>
		</TR>
	</TABLE>
</form>
