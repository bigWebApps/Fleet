	...
	public class clsCustFields : clsDBInteractionBase
	{
		...
		public int CustFieldsEquipment()
		{
			...
			try
			{
				...
				scmCmdToExecute.Parameters.Add(new SqlParameter("@btIsComponent", SqlDbType.Bit, 1, ParameterDirection.InputOutput, false, 1, 0, "", DataRowVersion.Default, m_bitIsComponent));
				...
				m_bitIsComponent = (SqlBoolean)scmCmdToExecute.Parameters["@btIsComponent"].Value;
