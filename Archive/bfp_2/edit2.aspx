...
<%@ Page language="c#" Codebehind="edit2.aspx.cs" AutoEventWireup="false" Inherits="BWA.BFP.Web.home.equip._edit2" errorPage="error.aspx"%>
...
<FORM id="Form1" runat="server">
	<TABLE>
		<TR>
			<TD class="RowCap" width="144">Status</TD>
			<TD class="RowElem"><asp:dropdownlist id="ddStatusId" runat="server"></asp:dropdownlist></TD>
			<TD class="RowHelp"></TD>
		</TR>
		<TR>
