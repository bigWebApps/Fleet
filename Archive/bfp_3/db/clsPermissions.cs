	...
	public class clsPermissions : clsDBInteractionBase
	{
		...
		public int PermissionDetail()
		{
			...
			try
			{
				...
				scmCmdToExecute.Parameters.Add(new SqlParameter("@vchName", SqlDbType.VarChar, 150, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, m_sName));
				scmCmdToExecute.Parameters.Add(new SqlParameter("@chCode", SqlDbType.Char, 3, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Default, m_sCode));
