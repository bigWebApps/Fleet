...
namespace BWA.BFP.Core
{
	...
	/// <summary>
	/// The data type of Custom Fields
	/// </summary>
	...
	public class _functions
	{
		...
		public static string ErrorMessage(int Code)
		{
			try
			{
				switch(Code)
				{
					...
					case 118:
						return "Cannot remove the Group because this Group have the Users";
					default:
		...
		public static void Log(Exception ex, string sUserOrgId, string sPageName)
		{
